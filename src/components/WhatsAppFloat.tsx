...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="float-in group/wa fixed right-4 bottom-[calc(1rem+env(safe-area-inset-bottom))] z-40 inline-flex size-14 items-center justify-center rounded-full bg-brand text-white shadow-lg shadow-black/25 transition-[background-color,scale,box-shadow] duration-300 ease-(--ease-soft) hover:scale-105 hover:bg-brand-hover hover:shadow-xl hover:shadow-brand/25 active:scale-100 active:bg-brand-active sm:right-6 sm:bottom-[calc(1.5rem+env(safe-area-inset-bottom))]"
    >
