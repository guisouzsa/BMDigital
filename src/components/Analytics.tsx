...
// Aceita apenas IDs alfanuméricos com hífen, para não injetar nada inesperado nos scripts.
const clean = (value?: string) => (value && /^[A-Za-z0-9-]+$/.test(value) ? value : undefined);
...
/** GTM, GA4 e Pixel da Meta: cada um só carrega se a variável de ambiente existir. */
